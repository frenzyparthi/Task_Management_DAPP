  ...
  return (
    <div id="totalpage">
      {currentAccount === '' ? (
        ...
        <div className="App">
          <h2 id="header1"> Todo List Powered by Blockchain </h2>
          <h3 id="headercolor"> Developed by Parthiban </h3>
          <form>
            <TextField id="outlined-basic" label="Make Todo" variant="outlined" style={{ margin: "0px 5px" }} size="small" value={input}
              onChange={e => setInput(e.target.value)} />
            <Button id="buttonfont" variant="contained" color="primary" onClick={addTask}  >Add Task</Button>
          </form>
          <ul>
            <li id="listData">
              {tasks.map(item =>
